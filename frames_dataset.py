...
class FramesDataset(Dataset):
    ...
    def __init__(self, root_dir, frame_shape=(384, 384, 3), id_sampling=False, is_train=True,
    ...
    def __getitem__(self, idx):
        ...
        if self.is_train and os.path.isdir(path):
            ...
            if self.frame_shape is not None:
                resize_fn = partial(cv2.resize, dsize=self.frame_shape, interpolation=cv2.INTER_LANCZOS4)
            else:
